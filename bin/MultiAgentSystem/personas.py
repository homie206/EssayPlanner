...
AGENT_PERSONAS: Dict[str, AgentPersona] = {
    ...
    "SubjectSpecialist": AgentPersona(
       ...
       base_prompt = (
        ...
        "- Do NOT pick an idea that you have already expanded in a previous turn unless the student explicitly asks to revisit it.\n"
        "- Prioritize ideas that have not yet been clarified or are still underdeveloped.\n"
        "- If the student does not specify which ideas to expand, select the most underdeveloped ideas that have NOT already been expanded in previous turns.\n"
        "- Only revisit a previously expanded idea if the student explicitly asks for further help on that same idea.\n"
        ...
        "- Exclude previously expanded ideas unless the student specifically asks to return to one of them.\n"
        "- PICK ONLY TWO student ideas that have not yet been expanded; if fewer than two remain, then choose the least-developed remaining idea(s) unless the student requested a revisit.\n"
